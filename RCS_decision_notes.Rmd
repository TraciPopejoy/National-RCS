...
worldclim_gdf<-sub_CS_calc %>% 
  ...
  dplyr::select(species, spatial_extent_cat,variable, value) 
...
Need to decide if I want to restrict observations to the native range or include the invasive range as well. 